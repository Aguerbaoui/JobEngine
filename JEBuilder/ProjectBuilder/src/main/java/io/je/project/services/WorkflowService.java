...
public class WorkflowService {
    ...
    public String addWorkflowBlock(WorkflowBlockModel block)
        ...
        switch (block.getType()
            ...
            case WorkflowConstants.SMS_TYPE: {
                project.addBlockToWorkflow(getSMSBlock(project, wf, block, false));
                break;
            }
            default: {
    ...
    //get script block
    public ScriptBlock getScriptBlock(JEProject project, JEWorkflow wf, WorkflowBlockModel block, boolean update) throws Exception {
    ...
    public void updateWorkflowBlock(WorkflowBlockModel block)
        ...
        switch (block.getType()
            ...
            case WorkflowConstants.SMS_TYPE: {
                project.addBlockToWorkflow(getSMSBlock(project, wf, block, true));
                break;
            }
            default: {
                throw new WorkflowBlockNotFoundException(JEMessages.WORKFLOW_BLOCK_NOT_FOUND);
    ...
    public void removeWorkflow(String projectId, String workflowId)
        ...
        Enumeration<String> blockIds = project.getWorkflowByIdOrName(workflowId)
                .getAllBlocks()
                .keys();
