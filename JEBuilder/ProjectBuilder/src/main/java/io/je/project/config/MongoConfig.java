...
public class MongoConfig extends AbstractMongoClientConfiguration {
    ...
    protected String getDatabaseName() {
        return SIOTHConfiguration.getDataBaseName();
    }

    @Override
    public MongoClient mongoClient() {
        final ConnectionString connectionString = new ConnectionString("mongodb://"+SIOTHConfiguration.getMongoServerHostName()+":"+SIOTHConfiguration.getMongoServerPort()+"/"+getDatabaseName());
