...
public class RuleBuilder {
	 ...
	 */
	public static void sendDRLToJeRunner(JERule rule, String path, boolean ruleIsAdded) throws JERunnerErrorException, RuleBuildFailedException, IOException, InterruptedException, ExecutionException
	{
