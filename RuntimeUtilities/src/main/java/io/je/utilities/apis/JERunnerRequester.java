...
public class JERunnerRequester {
    ...
    private static void init() {
        try {
            requester = new ZMQRequester("tcp://" + SIOTHConfigUtility.getSiothConfig()
                    .getNodes()
                    .getSiothMasterNode(),
                    requesterPort);
    ...
    public static JEZMQResponse readClass(String instanceId) {
        RunnerRequestObject request = new RunnerRequestObject(RunnerRequestEnum.GET_CLASS);
        Map<String, Object> requestParams = new HashMap<>();
